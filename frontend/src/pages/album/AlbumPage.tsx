        ...
        <div className="relative z-0 min-h-full">
          ...
          <div
            className='absolute inset-0 bg-gradient-to-b from-[#5038a0]/80 via-zinc-900/80
					 to-zinc-900 pointer-events-none rounded-md'
            aria-hidden='true'
          />
          ...
          <div className="relative z-10">
            ...
            {/* play button */}
            <div className='px-6 pb-4 flex items-center gap-6 z-10'>
              <Button
                onClick={handlePlayAlbum}
                size='icon'
                className='w-14 h-14 z-10 rounded-full bg-green-500 hover:bg-green-400 
